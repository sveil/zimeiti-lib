 ...
 * --- Verify the product code of the SMS is：676767
 * --- The product code of the marketing SMS is：333333
 * ---------------------------------
 * ---------------------------------
 * Country code is required for sending international SMS [code]
 * --- See country code getGlobeRegionMap
 * ---------------------------------
 * ---------------------------------
 * If you need to open an SMS account, please contact customer service
 * --- consumer hotline
 * =================================
 */
class Extend extends Service
{
     ...
     * @param string $productid SMS channel ID
     * @return boolean
     * @throws Exception
     * @throws PDOException
     */
     ...
     * @param string $content Send Content
     * @return boolean
     * @throws Exception
     * @throws PDOException
     */
