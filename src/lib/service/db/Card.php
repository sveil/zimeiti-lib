...
use sveil\lib\model\Card as CardModel;
use sveil\lib\Service;

/**
 * Class Card
 * Card db data service
...
class Card extends Service
{
    ...
    {
        return UuidModel::where('tb_name', 'card')->update(['is_disabled' => 2]);
    }
}
