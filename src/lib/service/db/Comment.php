...
use sveil\lib\model\Comment as CommentModel;
use sveil\lib\Service;

/**
 * Class Comment
 * Comment db data service
...
class Comment extends Service
{
    ...
    {
        return UuidModel::where('tb_name', 'comment')->update(['is_disabled' => 2]);
    }
}
