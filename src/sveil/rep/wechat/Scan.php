...
class Scan extends WeChat
{
     ...
     * @param string $status Support pulling by status. On is the release status, off is the unreleased status,
     * check is the status under review, reject is the status of failed review, and all is the status of all.
     * @param string $keystr Support to pull according to part of the encoded content. After filling in this parameter,
     * you can pull out the commodity information that contains the passed parameter in the encoded content. Similar keyword search.
     * @return array
     * @throws InvalidResponseException
     * @throws LocalCacheException
     */
